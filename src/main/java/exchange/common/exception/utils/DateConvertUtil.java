...
public class DateConvertUtil {
     ...
     * Timestamp转Date
     */
    public static Date timestamp2Date(Timestamp value) {
        return Objects.isNull(value) ? null : new Date(value.getTime());
    }

    /**
     * Timestamp转LocalDateTime
     */
    public static LocalDateTime timestamp2LocalDateTime(Timestamp value) {
        return Objects.isNull(value) ? null : value.toLocalDateTime();
    }

    /**
     * Timestamp转LocalDate
     */
    public static LocalDate timestamp2LocalDate(Timestamp value) {
        return Objects.isNull(value) ? null : value.toLocalDateTime().toLocalDate();
    }

    /**
     * Timestamp转String
     */
    public static String timestamp2String(Timestamp value, String pattern) {
        if (StringUtils.isBlank(pattern)) {
            throw new RuntimeException("请输入pattern，如：yyyy-MM-dd HH:mm:ss");
        }
        return Objects.isNull(value) ? null : date2String(timestamp2Date(value), pattern);
    }

    /**
     * Timestamp转Long
     */
    public static Long timestamp2Long(Timestamp value) {
        return Objects.isNull(value) ? null : value.getTime();
    }
     ...
     * Timestamp转Instant
     */
    public static Instant timestamp2Instant(Timestamp value) {
        return Objects.isNull(value) ? null : Instant.ofEpochMilli(value.getTime());
    }
    //endregion
    ...
    public static Date long2Date(Long value) {
        return Objects.isNull(value) ? null : new Date(value);
    }

    /**
     * Long转LocalDateTime
     */
    public static LocalDateTime long2LocalDateTime(Long value) {
        return Objects.isNull(value) ? null : LocalDateTime.ofInstant(Instant.ofEpochMilli(value), zoneId);
    }

    /**
     * Long转LocalDate
     */
    public static LocalDate long2LocalDate(Long value) {
        return Objects.isNull(value) ? null : LocalDateTime.ofInstant(Instant.ofEpochMilli(value), zoneId).toLocalDate();
    }

    /**
     * Long转String
     */
    public static String long2String(Long value, String pattern) {
        if (StringUtils.isBlank(pattern)) {
            throw new RuntimeException("请输入pattern，如：yyyy-MM-dd HH:mm:ss");
        }
        return Objects.isNull(value) ? null : date2String(long2Date(value), pattern);
    }
     ...
     * Long转Instant
     */
    public static Instant long2Instant(Long value) {
        return Objects.isNull(value) ? null : Instant.ofEpochMilli(value);
    }
    //endregion
     ...
     * Instant转Date
     */
    public static Date instant2Date(Instant value) {
        return Objects.isNull(value) ? null : new Date(value.toEpochMilli());
    }

    /**
     * Instant转LocalDateTime
     */
    public static LocalDateTime instant2LocalDateTime(Instant value) {
        return Objects.isNull(value) ? null : LocalDateTime.ofInstant(value, zoneId);
    }

    /**
     * Instant转LocalDate
     */
    public static LocalDate instant2LocalDate(Instant value) {
        return Objects.isNull(value) ? null : LocalDateTime.ofInstant(value, zoneId).toLocalDate();
    }

    /**
     * Instant转String
     */
    public static String instant2String(Instant value, String pattern) {
        if (StringUtils.isBlank(pattern)) {
            throw new RuntimeException("请输入pattern，如：yyyy-MM-dd HH:mm:ss");
        }
        return Objects.isNull(value) ? null : date2String(instant2Date(value), pattern);
    }

    /**
     * Instant转Timestamp
     */
    public static Timestamp instant2Timestamp(Instant value) {
        return Objects.isNull(value) ? null : new Timestamp(value.toEpochMilli());
    }

    /**
     * Instant转Long
     */
    public static Long instant2Long(Instant value) {
        return Objects.isNull(value) ? null : value.toEpochMilli();
    }
    //endregion
